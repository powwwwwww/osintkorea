...
// Animated starfield / nebula / parallax-mountain backdrop, adapted from the
// horizon-hero-section canvas scene but stripped of the scroll-driven
// sections, title and menu so it can sit behind existing page content as a
